...
// Adapter function to convert our config to SpecsManager config format
export function toDataConfig(
	config?: Partial<SpecConfig> | Partial<ServiceConfig>,
): {
	path?: string;
	autoDetect: boolean;
...
export const WorkflowValidationOptionsSchema = z.object({
	...
	checkFlowContinuity: z.boolean().optional(),
	checkTaskDependencies: z.boolean().optional(),
	checkTestCoverage: z.boolean().optional(),
	allowParallelTasks: z.boolean().optional(),
});
